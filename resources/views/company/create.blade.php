    ...
    <div class="overflow-x-auto p-6">
        ...
        <form method="POST" action="{{ route('companies.store') }}"
            ...
            <div class="mb-4 p-6 bg-gray-50 border-gray-100 rounded-lg shadow-sm">
                ...
                <x-input-field label="Company Name" name="name" />
                ...
                <x-input-field label="Website (optional)" name="website" type="url" />
            </div>
            ...
            <div class="mb-4 p-6 bg-gray-50 border-gray-100 rounded-lg shadow-sm">
                ...
                <x-input-field label="Company Owner Name" name="owner_name" />
                <x-input-field label="Owner email" name="owner_email" />
            ...
            <div class="flex flex-row flex-wrap gap-3 items-center justify-end">
                <a href="{{ route('companies.index') }}" class="text-grey-500 hover:text-grey-700 ">←
                    Cancel
                </a>
