    ...
    <div class="overflow-x-auto p-6">
        ...
        <form method="POST" action="{{ route('job-vacancies.store') }}"
            ...
            <div class="mb-4 p-6 bg-gray-50 border-gray-100 rounded-lg shadow-sm">
                ...
                <x-input-field label="location" name="location" />
            ...
            <!-- job description -->
             <div class="mb-4">
                ...
                <textarea name="description" id="description" rows="4" class="mt-1 block w-full rounded-md shadow-sm border-gray-300 focus:border-indigo-500">
                    {{ old('description') }}
                </textarea>
                @error('description')
                    <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
